...
export class RetailMonthComponent implements OnInit {
    ...
    public readonly DISPLAY_COLS: string[] = ['index', 'chi_tieu', 'don_vi', 'cung_ky', 'ke_hoach', 'thuc_hien_thang_truoc', 'thuc_hien_thang','luy_ke_so_ke_hoach', 'thuc_hien_so_voi_thang_truoc', 'thuc_hien_so_voi_cung_ky'];
