...
exports.BorderTradeExportComponent = void 0;
...
var data_1 = require("../border-trade-export/data");
var BorderTradeExportComponent = /** @class */ (function () {
    function BorderTradeExportComponent(sctService, matDialog, marketService, _breadCrumService) {
    ...
    BorderTradeExportComponent.prototype.handleGTXK = function () {
    ...
    BorderTradeExportComponent.prototype.initVariable = function () {
        this.TongLuongThangThucHien = 0;
        this.TongGiaTriThangThucHien = 0;
        this.TongLuongCongDon = 0;
        this.TongGiaTriCongDon = 0;
    ...
    BorderTradeExportComponent.prototype.kiem_tra = function (id_mat_hang) {
        if (this.xuat_khau_chu_yeu.includes(id_mat_hang))
            return true;
        return false;
    };
    BorderTradeExportComponent.prototype.ngOnInit = function () {
        this.getDanhSachXuatKhau(this.curentmonth);
        this.autoOpen();
        this.sendLinkToNext(true);
        this.handleGTXK();
    };
    BorderTradeExportComponent.prototype.sendLinkToNext = function (type) {
    ...
    BorderTradeExportComponent.prototype.autoOpen = function () {
        var _this = this;
    ...
    // }
    BorderTradeExportComponent.prototype.getDanhSachXuatKhau = function (value) {
    ...
    BorderTradeExportComponent.prototype.tinh_tong = function (data) {
        this.initVariable();
    ...
    BorderTradeExportComponent.prototype.ngAfterViewInit = function () {
        //Called after ngAfterContentInit when the component's view has been initialized. Applies to components only.
        //Add 'implements AfterViewInit' to the class.
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    BorderTradeExportComponent.prototype.log = function (any) {
        console.log(any);
    };
    BorderTradeExportComponent.prototype.applyFilter = function (event) {
    ...
    BorderTradeExportComponent.prototype.getYears = function () {
        return Array(5)
            .fill(1)
            .map(function (element, index) { return new Date().getFullYear() - index; });
    };
    BorderTradeExportComponent.prototype.applyDistrictFilter = function (event) { };
    // isHidden(row : any){
    //     return (this.isChecked)? (row.is_het_han) : false;
    // }
    BorderTradeExportComponent.prototype.applyExpireCheck = function (data) {
        var _this = this;
        // console.log(data);
    ...
    BorderTradeExportComponent.prototype.openDialog = function (id_mat_hang) {
    ...
    BorderTradeExportComponent.prototype.handelDataDialog = function (id_mat_hang) {
        var data = this.dataDialog.filter(function (item) { return item.id_mat_hang === id_mat_hang; });
        return data;
    };
    BorderTradeExportComponent.prototype.openDanh_sach_doanh_nghiep = function (id_mat_hang, ten_san_pham) {
        var _this = this;
        this.marketService
    ...
    BorderTradeExportComponent.prototype.applyDataTarget = function (value) {
    };
    BorderTradeExportComponent.prototype.ExportTOExcel = function (filename, sheetname) {
    ...
    ], BorderTradeExportComponent.prototype, "table");
    __decorate([
        core_1.ViewChild(material_1.MatAccordion, { static: true })
    ], BorderTradeExportComponent.prototype, "accordion");
    __decorate([
        core_1.ViewChild("paginator", { static: false })
    ], BorderTradeExportComponent.prototype, "paginator");
    __decorate([
        core_1.ViewChild(material_1.MatSort, { static: false })
    ], BorderTradeExportComponent.prototype, "sort");
    BorderTradeExportComponent = __decorate([
        core_1.Component({
    ...
    return BorderTradeExportComponent;
}());
exports.BorderTradeExportComponent = BorderTradeExportComponent;
